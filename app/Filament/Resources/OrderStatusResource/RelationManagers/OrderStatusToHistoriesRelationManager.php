...
class OrderStatusToHistoriesRelationManager extends RelationManager
{
    protected static string $relationship = 'toStatusHistories';

    protected static ?string $title = 'To Status Changes';
